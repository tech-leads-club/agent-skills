  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="text-center mb-16">
        <h1 className="text-5xl font-bold text-gray-900 mb-4">Agent Skills Marketplace</h1>
      ...
      <div className="bg-white rounded-lg shadow-md p-8 mb-16 border border-gray-200">
        ...
        <p className="text-gray-600 mb-4">Install skills directly from the command line:</p>
        <div className="bg-gray-50 rounded-md p-4 mb-4">
          <code className="text-sm text-gray-800">npx @tech-leads-club/agent-skills --skill [skill-name]</code>
        </div>
      ...
      <div>
        <div className="flex items-center justify-between mb-6">
          ...
          <Link href="/skills" className="text-blue-600 hover:text-blue-700 font-medium">
            View All →
          </Link>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {featuredSkills.map((skill) => {
            ...
            return (
              <div key={skill.id} className="bg-white rounded-lg shadow-md border border-gray-200 p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link href={`/skills/${skill.id}`} className="text-blue-600 hover:text-blue-700 text-sm font-medium">
                    View →
                  </Link>
                </div>
              </div>
