    ...
    <>
      ...
      <div className="bg-white dark:bg-gray-900 rounded-lg shadow-md p-8 mb-16 border border-gray-200 dark:border-gray-800">
        ...
        <div className="bg-gray-50 dark:bg-gray-800 rounded-md p-4 mb-4">
          <code className="text-sm text-gray-800 dark:text-gray-200">npx @tech-leads-club/agent-skills --skill [skill-name]</code>
        </div>
      ...
      <div>
        <div className="flex items-center justify-between mb-6">
          ...
          <Link href="/skills" className="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-medium">
            View All →
          </Link>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {featuredSkills.map((skill) => {
            ...
            return (
              <div key={skill.id} className="bg-white dark:bg-gray-900 rounded-lg shadow-md border border-gray-200 dark:border-gray-800 p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link href={`/skills/${skill.id}`} className="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 text-sm font-medium">
                    View →
                  </Link>
                </div>
              </div>
