...
description: Surface Monte Carlo data observability context (table health, alerts, lineage, blast radius) before SQL or dbt edits. Use when user says "check this table", "what's the impact of this change", "run impact assessment", or opens a dbt model file. Do NOT use for seed files, analysis files, or non-dbt SQL scripts.
metadata:
  version: '1.0.0'
  author: github.com/monte-carlo-data
---
