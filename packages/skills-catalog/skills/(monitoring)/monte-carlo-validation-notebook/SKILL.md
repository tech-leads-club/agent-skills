...
description: Generate SQL validation notebooks for dbt PR changes with before/after comparison queries. Use when user says "validate this PR", "generate validation queries", "create a validation notebook", or provides a GitHub PR URL or local dbt repo path. Do NOT use for running queries directly or non-dbt SQL changes.
metadata:
  version: '1.0.0'
