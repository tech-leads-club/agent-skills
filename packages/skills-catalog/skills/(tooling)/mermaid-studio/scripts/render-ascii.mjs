...
async function renderAscii(mmdContent, bmPath, opts) {
  try {
    ...
    const renderFn =
      bm.renderMermaidAscii || bm.renderAscii || bm.default?.renderMermaidAscii || bm.default?.renderAscii
    ...
    const generalRender = bm.renderMermaid || bm.render || bm.default?.renderMermaid || bm.default?.render
