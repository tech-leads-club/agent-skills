---
name: linkedin-cli
description: CLI-based LinkedIn automation via Linked API. Fetch profiles, search people and companies, send messages, manage connections, create posts, and use Sales Navigator. Use when the user wants to automate LinkedIn interactions.
---
