---
name: scrapling
description: "Web scraping with Scrapling — HTTP fetching, stealth browser automation, Cloudflare bypass, and spider crawling via CLI and Python. Three strategies: Fetcher (static HTTP), DynamicFetcher (JS-rendered), StealthyFetcher (anti-bot bypass). Use when "scrape this website", "bypass Cloudflare", "crawl these pages", "extract data from site", or "stealth scraping". Do NOT use for API consumption, simple curl requests, or sites that provide structured data feeds."
license: CC-BY-4.0
metadata:
  version: '1.0.0'
